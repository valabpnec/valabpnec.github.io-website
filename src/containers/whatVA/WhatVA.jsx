    ...
    return(
        <div className="va__whatva section__margin" >
            <div className="va__whatva-feature" id="whatVALAB">
                <Feature title="Video Analytics Lab Introduction" text="Video Analytics (VA) Lab aka Video Surveillance Lab at PNEC-NUST established in August 2016 is focusing on providing indigenous and state-of-the-art Artificial Intelligence (AI) and Augmented Reality - Virtual Reality (AR-VR) based solutions. VA Lab is also a partner lab of the National Center of Big Data and Cloud Computing (NCBC). The lab is headed by Dr. Rana Hammad Raza." />
            </div>
            <div className="va__whatva-heading">
                ...
                <a href="https://projects.pnec.nust.edu.pk/va/publications.html" target="_blank" >Explore our research publications</a> 
            </div>
